    ...
    const { data: order } = useQuery<Order>({
        ...
        queryFn: () => {
            const queryString = new URLSearchParams({
                ...
                fields: 'cart,address,paymentMode,storeId,total,comment,orderStatus,paymentStatus,createdAt',
            }).toString();
                                ...
                                <List.Item>
                                    <List.Item.Meta
                                        ...
                                        description={item.chosenConfiguration.selectedAccessorys
                                            // todo: IMPORTANT: check why there is a nested array in selected accessorys
